    ...
    def on_select(event):
        try:
            ...
            if "ID:" in line:
                ...
                fields["Name"].insert(0, patient['name'] or "")
                fields["Species"].delete(0, "end")
                fields["Species"].insert(0, patient['species'] or "")
                fields["Breed"].delete(0, "end")
                fields["Breed"].insert(0, patient['breed'] or "")
                fields["Age"].delete(0, "end")
                fields["Age"].insert(0, str(patient['age'] or 0))
                fields["Owner Name"].delete(0, "end")
                fields["Owner Name"].insert(0, patient['owner_name'] or "")
                fields["Owner Contact"].delete(0, "end")
                fields["Owner Contact"].insert(0, patient['owner_contact'] or "")
